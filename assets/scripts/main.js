...
function loadDefaultExample() {
  markdownInput.value = `# 公众号 Markdown 编辑器
...
2. **传统媒体系列**：晚点、金融时报、纽约时报、Jony Ive
3. **现代数字系列**：Claude、Wired、Medium、Apple
4. **设计灵感系列**：原研哉、Hische、安藤、高迪
