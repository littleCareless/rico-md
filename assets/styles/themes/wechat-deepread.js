...
export const theme = {
  ...
  "styles": {
    ...
    "h5": "font-size: 16px; font-weight: 600; color: #3a3a3a !important; line-height: 1.5 !important; margin: 24px 0 12px;",
    "h6": "font-size: 16px; font-weight: 500; color: #4a4a4a !important; line-height: 1.5 !important; margin: 20px 0 10px;",
    ...
    "blockquote": "margin: 24px 0; padding: 14px 20px; background-color: #f8f9fa !important; border-left: 4px solid #0a0a0a; color: #1a1a1a !important; font-size: 16px; line-height: 1.6 !important; font-style: normal;",
    "code": "font-family: \"SF Mono\", Consolas, Monaco, \"Courier New\", monospace; font-size: 15px; padding: 2px 6px; background-color: #f6f8fa !important; color: #d73a49 !important; border-radius: 3px;",
    "pre": "margin: 32px 0; padding: 24px; background-color: #f6f8fa !important; border-radius: 8px; overflow-x: auto; line-height: 1.6 !important; border: 1px solid #e1e4e8;font-size: 15px;",
